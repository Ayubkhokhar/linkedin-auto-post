...
POST_PROMPTS = {
    "niche_solutions": """You are Irfan, an expert web and mobile developer from Pakistan targeting clients in the US and Europe.
...
Write the post now. No intro, no explanation — just the post content:""",
    ...
    "expertise_showcase": """You are Irfan, a top-rated freelance developer from Pakistan specializing in web/mobile architectures for global clients (US/Europe).
...
Write the post now. No intro, no explanation — just the post content:""",
    ...
    "client_growth_story": """You are Irfan, a successful freelance software engineer (Upwork/Fiverr) from Pakistan working with international clients.
...
Write the post now. No intro, no explanation — just the post content:""",
    ...
    "tech_discovery": """You are Irfan, an expert web & mobile developer building scalable apps for international clients.
...
if __name__ == "__main__":
    ...
    main(dry_run=args.dry_run or DRY_RUN, hint=args.hint)
>>>>>>> 6efd4fc (feat: complete overhaul of content strategy for US/EU clients and specific niches)
